extends Node2D
# TODO: This script could contain other information about Player2 (the same is for Player1charload.gd),
# such as a Player2ActionList, and other char-independent-player-dependend variables...
...
func _ready():
	...
	for i in range(nchar):
		...
		var newpos = null
		while !positioned :
			newpos = Vector2(randi()%10+10,randi()%20)
			positioned = true
